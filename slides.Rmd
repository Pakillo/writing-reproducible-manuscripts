...
```{r out.width = '3in', out.height = '1.6in'}
...
include_graphics("images/besguide.png")
```
...
```{r out.width = '4in', out.height = '1.1in'}
...
```{r out.width = '2.5in', out.height = '1.2in'}
...
*Incluir Fig R vs Word (broken workflow)*
...
\footnotesize ¡Como escribir en procesador de texto, pero todas las ventajas de Rmarkdown!
...
## Script maestro ejecuta scripts en orden
...
## `checkpoint` reconstruye ecosistema de paquetes en fecha determinada
...
## `automagic` detecta e instala paquetes (CRAN + GitHub)
...
necesitamos controlar el **sistema/entorno computacional**
...
```{r out.width = '4in', out.height = '1.8in'}
